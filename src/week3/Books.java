...
public class Books {
    public static void main(String[] args) {
       ...
       if(isValid ){
           String message =" The genre " + genre + " genre usually has profits of " + profit + " being sold in " + countries + " different countries. The " + genre + " books often have " + sequels + "sequels with each book roughly being around " +pageLength + " pages.";
